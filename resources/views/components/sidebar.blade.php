<div class="sidebar hide-on-print">
    ...
    <ul class="side-menu">
        ...
        @if ($user->role == 1) 
            ...
            <li class="{{ Request::is('reports') || Request::is('sales-reports') || Request::is('inventory-reports') || Request::is('item-logs') ? 'active' : '' }}"><a href="/reports"><i class='bx bxs-chart'></i>Reports</a></li>
